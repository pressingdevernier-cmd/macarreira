...
# Ligne CSV (hors en-tete): 7500
# Empreinte source SHA256: 26024f26f899c4b74806418cc561c1c90adeecbdf3eac6512168a83c8bca1b49
...
# Verifications: accord_apres_fin_ligne, ligne_accords_non_reconnue, ponctuation_chordpro_neutralisee, tablature_conservee_en_commentaire, tabulations_interpretees_4_colonnes, tonalite_absente
            ...
            ACOUSTIC GUITAR:
# TAB:                 HIGH E STRING ---0-0-0-0-0-0-0-0- ETC. 
# TAB:                      B STRING ---5-5-5-5-5-5-5-5- ETC. 

{start_of_part: INTRO}
    ELECTRIC GUITAR - (GO HEAVY ON THE DISTORTION)

[E] [B] [A] [D] [E] [B] [A] [E] [B] [A] [D] [A] [B] [B] [A] [D] [E] [B]

{end_of_part}
{start_of_verse: VERSE}
      Y[B]ou fell out of the cl[A]ear blue s[D]ky     **NOTE: DURING THE
{comment: À vérifier : E B ENTIRE VERSE}
# SOURCE A VERIFIER:       E                  B                           ENTIRE VERSE 
      To the darkness below                          PLAY THE
      The smell of your flesh excites me             PATTERN:
      Blood starts to flow, so help me God          B  A  D  E  B
...
{end_of_part}
{start_of_part: BREAK}
      O[E]ne punch and you knocked me down
      T[D]ore my defenses ap[A]art
     [E] One round took me out of the game
      You d[D]id me some permanent h[A]arm
      It took just one h[B]it [A][B]
      [B]It took just one hit [A][B]
      [B]It ain't enough for me [A][D]
      It ain't en[B]ough for me [A][D]
      (Enough for me)
      It ain't en[B]ough for me
      It's hu[A]rting, it's fri[D]ghten h[E]ey!

{comment: À vérifier : INSTRUMENTAL: B A D E B -- 2x's}
# SOURCE A VERIFIER: INSTRUMENTAL:   B  A  D  E  B -- 2x's 
...
{comment: À vérifier : INSTRUMENTAL: SOLO OVER B A D E B -- 2x's}
# SOURCE A VERIFIER: INSTRUMENTAL:    SOLO OVER  B  A  D  E  B -- 2x's 
