...
# Ligne CSV (hors en-tete): 103233
# Empreinte source SHA256: 4f2ec2628227fe8570e6adcea250d1d421587431fc2f435bf0e15e20ea062e10
...
# SOURCE A VERIFIER: >From: [email protected] (Wade Blomgren) 
>From: ［email protected］ (Wade Blomgren)

Subject: Re: REQ: "Waiting on a Friend", Stones

# SOURCE A VERIFIER: In an article, [email protected] (patrick m. ryan) writes: 
In an article, ［email protected］ (patrick m. ryan) writes:
...
# SOURCE A VERIFIER: Csus2 (x4)  Dm F {repeat, with "doo doo" vocals, piano solo} 
...
# SOURCE A VERIFIER: Csus2  Dm F {repeat, sax solo followed by ad lib-ish "doo doo"} 
...
# SOURCE A VERIFIER: Csus2  Dm F {repeat, more sax solo followed by ad lib "doo doo"} 
...
# SOURCE A VERIFIER: >From: [email protected] (L'Angelo Misterioso) 
>From: ［email protected］ (L'Angelo Misterioso)
