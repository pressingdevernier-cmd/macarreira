...
# Ligne CSV (hors en-tete): 21358
# Empreinte source SHA256: 72f690e0edc0aa43a68a605ab3f7b6f7e2750d8bd7562c26f5f479f545aa3b02
...
If I [C]had my way, hey I'd [G]always be
...
And you can [C]do alright if you a[G]in't afraid to be
...
{comment: À vérifier : (Instrumental-bridge) C F C G C F, C G C,}
# SOURCE A VERIFIER: (Instrumental-bridge) C F  C G  C F, C G C, 
...
{comment: À vérifier : (Instrumental) C F C G}
# SOURCE A VERIFIER: (Instrumental) C  F  C  G 

(sung simultaneously)
(Layin' l[C]ow, just my baby and [F]me)
          Sunny sky as far as I can see
([C]High up in a [G]coconut [C]tree)
 High    in a coconut tree

{comment: À vérifier : (Instrumental) C F G C}
# SOURCE A VERIFIER: (Instrumental) C  F  G  C 

[C]Sunny sky as far as [F]I can see
[C]High up in a [G]coconut [C]tree
[C]Up here with Willie [G]
[C]Sunny sky as far as [F]I can see
{comment: À vérifier : C G C F, C G, C F, C G C (fade)}
# SOURCE A VERIFIER:           C         G       C     F, C G, C F, C G C (fade) 
