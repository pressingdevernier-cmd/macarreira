...
# Ligne CSV (hors en-tete): 7383
# Empreinte source SHA256: a06cb03a69fa8045d5c7599a7e09f25e5689fe9fcbd08ebfef9f24813c75f299
...
# Verifications: accord_apres_fin_ligne, ligne_accords_non_reconnue, ponctuation_chordpro_neutralisee, tabulations_interpretees_4_colonnes, tonalite_absente
                              ...
                              sl.   sl.
{comment: À vérifier : INTRO: -- 5x's C / Bb / C}
# SOURCE A VERIFIER: INTRO: -- 5x's   C  / Bb / C 
                 ///  //   //
...
{start_of_chorus: Chorus}
      L[F]ove is a m[C]ystery [F]I can't dem[C]ystify, oh, [F]no [C]
    [Bb]  And sometimes I wonder why we're h[C]ere
      But [F]I don't c[Bb]are, I don't c[C]are [F][C]
