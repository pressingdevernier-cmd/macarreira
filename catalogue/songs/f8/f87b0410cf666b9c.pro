{title: Like a Rolling Stone (ver. 2)}
{artist: Mick Jagger}
{status: en_travail}
...
# Ligne CSV (hors en-tete): 103125
# Empreinte source SHA256: f87b0410cf666b9c2dc43d5ff9b76462392e3b41119005f3e214c5437527a6ee
...
(C)People'd call, say, "(Dm)Beware doll, you're(Em) bound to fall"
You thought (F)they were all(G)kiddin' you
(F)You used to(G) laugh about
(F)Everybody that was(G) hangin' out
(F)Now you(Em) don't(Dm) talk so(C) proud
(F)Now you(Em) don't(Dm) seem so(C) loud
A(F)bout having to be scrounging for your next(G) meal.
...
Ah,You've(C) gone to the(Dm) finest school all(Em) right, Miss Lonely
But you(F) know you only used to get(G) juiced in it
And no(C)body has ever taught you(Dm) how to live on the(Em) street
...
And(F) say do you want to make a(G) deal?
...
You(C) never turned around to(Dm) see the frowns on the jugglers and the(Em) clowns
...
(F)Ain't it(Em) hard when you di(Dm)scover that(C)
(F)He really(Em) wasn't(Dm) where it's(G) at
(F)After he took from you everything he could(G) steal.
