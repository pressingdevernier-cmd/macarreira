...
# Ligne CSV (hors en-tete): 7481
# Empreinte source SHA256: fa4e6d2775a35e64b6f39e951c01b5c3a1c56613964ba6f3f9b59cbd4a9b90fd
...
{comment: À vérifier : INTRO: G C F G C F C Csus4 C -- 2x's}
# SOURCE A VERIFIER:             INTRO:   G  C  F  G  C    F  C  Csus4  C  -- 2x's 

{start_of_verse: VERSE}
       [F]I want a real fine c[C]ar, [Csus4][C]
       F[F]ly Miami t[C]oo [Csus4][C]
       A[F]ll the rum I want to dr[C]ink it,[Csus4] [C]
       A[F]ll the whiskey t[C]oo. [Csus4][C]
       [F]My woman need a n[C]ew dress, [Csus4][C]
       [F]My daughter got to go to sc[C]hool [Csus4][C]
       I'm w[G]orking so h[C]ard,
       I'm wo[F]rking for the c[G]ompa[C]ny. [F][C][Csus4][C]
       I'm wo[G]rking so h[C]ard to k[F]eep you in the l[G]uxu[C]ry. [F][C][Csus4][C]
